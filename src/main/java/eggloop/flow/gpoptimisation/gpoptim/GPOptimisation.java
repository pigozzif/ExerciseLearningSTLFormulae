...
import eggloop.flow.gaussianprocesses.gp.HyperparamLogLikelihood;
import eggloop.flow.gaussianprocesses.gp.kernels.KernelFunction;
import eggloop.flow.gaussianprocesses.gp.regression.RegressionGP;
import eggloop.flow.gpoptimisation.gpoptim.tranformations.EmptyTransformer;
import eggloop.flow.gpoptimisation.gpoptim.tranformations.LogTransformer;
import eggloop.flow.gpoptimisation.gpoptim.tranformations.Transformer;
import eggloop.flow.numeric.algebra.linalg.IAlgebra;
import eggloop.flow.numeric.algebra.linalg.JblasAlgebra;
import eggloop.flow.numeric.algebra.linalg.NonPosDefMatrixException;
import eggloop.flow.numeric.optimization.LocalOptimisation;
import eggloop.flow.numeric.optimization.ObjectiveFunction;
import eggloop.flow.numeric.optimization.PointValue;
import eggloop.flow.numeric.optimization.methods.PowellMethodApache;
